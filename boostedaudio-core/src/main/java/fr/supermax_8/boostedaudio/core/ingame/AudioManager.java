...
//
//    private static final ConnectionManager manager = BoostedAudioHost.getInstance().getWebSocketServer().manager;
//    private static final double maxDistance = BoostedAudioHost.getInstance().getConfiguration().getMaxVoiceDistance();
...
//            // Do nothing
//        } catch (Exception e) {
//            if (BoostedAudioHost.getInstance().getConfiguration().isDebugMode()) e.printStackTrace();
//        }
//    }
//
...
//                BoostedAudioAPI.api.debug("getConnectedUserAndClean close() session");
//                continue;
//            }
