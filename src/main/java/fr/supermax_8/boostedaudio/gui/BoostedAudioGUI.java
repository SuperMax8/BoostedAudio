...
import fr.supermax_8.boostedaudio.utils.AbstractGUI;
import fr.supermax_8.boostedaudio.utils.ItemUtils;
import fr.supermax_8.boostedaudio.utils.XMaterial;
    ...
    public void clickInCustomInv(InventoryClickEvent e) {
        ...
        switch (e.getSlot()) {
            case 1:
                ...
                new DirectoryShowGUI(owner, BoostedAudio.getInstance().getAudioDir());
                break;
            case 4:
                owner.closeInventory();
